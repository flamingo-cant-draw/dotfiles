...
(let ((bg-normal "#1d252c") (bg-dark "#181e24")
  ...
  (custom-theme-set-faces
   ...
   ;; Show paren
   `(show-paren-match ((t :foreground ,fg-yellow :weight extra-bold :inverse-video nil)))
   ...
   `(company-preview-common ((t :foreground ,fg-purple :weight bold)))
